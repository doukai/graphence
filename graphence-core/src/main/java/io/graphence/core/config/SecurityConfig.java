...
public class SecurityConfig {
  ...
  @Optional private String initialPassword;

  @Optional private Boolean buildPermission = false;

  @Optional private String rootUser;

  @Optional private String rootPassword;
