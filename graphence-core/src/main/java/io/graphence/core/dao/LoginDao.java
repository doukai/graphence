...
public interface LoginDao {
    ...
    @QueryOperation(value = "user", selectionSet = "{ id name lastName login salt hash email disable groups { id name path deep } roles { id name composites { id name composites { id name } } } realmId }")
