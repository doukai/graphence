...
/**
 * Subscription Arguments for Relationship Object between 角色 and 组 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Subscription Arguments for Relationship Object between 角色 and 组 List")
public class GroupRoleRelationConnectionSubscriptionArguments implements MetaExpression, GroupRoleRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Order By")
  private GroupRoleRelationGroupBy groupBy;
  ...
  public GroupRoleRelationGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(GroupRoleRelationGroupBy groupBy) {
