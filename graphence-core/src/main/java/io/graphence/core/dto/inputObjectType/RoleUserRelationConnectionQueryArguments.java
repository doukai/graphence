...
/**
 * Query Arguments for Relationship Object between 用户 and 角色 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 用户 and 角色 Connection")
public class RoleUserRelationConnectionQueryArguments implements MetaExpression, RoleUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
