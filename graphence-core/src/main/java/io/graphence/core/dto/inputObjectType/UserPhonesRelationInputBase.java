...
public interface UserPhonesRelationInputBase extends MetaInput {
  /**
   * id
   */
  @Description("id")
   ...
   */
  @Description("所属类型")
  String __typename = "UserPhonesRelation";

  /**
   * 匹配条件
   */
  @Description("匹配条件")
  UserPhonesRelationExpression where = null;
  ...
  default String getPhonesRef() {
    return phonesRef;
  }

  void setPhonesRef(String phonesRef);
  ...
  default UserPhonesRelationExpression getWhere() {
    return where;
  }

  void setWhere(UserPhonesRelationExpression where);
}
