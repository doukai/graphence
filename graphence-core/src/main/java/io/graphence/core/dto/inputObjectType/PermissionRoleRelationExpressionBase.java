...
public interface PermissionRoleRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("查询表达式组")
  Collection<PermissionRoleRelationExpression> exs = null;
  ...
  default Collection<PermissionRoleRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<PermissionRoleRelationExpression> exs);
}
