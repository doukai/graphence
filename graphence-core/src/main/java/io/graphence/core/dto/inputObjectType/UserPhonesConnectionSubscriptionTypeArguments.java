...
@Ignore
public class UserPhonesConnectionSubscriptionTypeArguments implements MetaExpression {
  ...
  private UserPhonesOrderBy orderBy;
  ...
  public UserPhonesOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(UserPhonesOrderBy orderBy) {
