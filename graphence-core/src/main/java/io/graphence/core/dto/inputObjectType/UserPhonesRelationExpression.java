...
public class UserPhonesRelationExpression implements MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  public Collection<UserPhonesRelationExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<UserPhonesRelationExpression> exs) {
    this.exs = exs;
  }
