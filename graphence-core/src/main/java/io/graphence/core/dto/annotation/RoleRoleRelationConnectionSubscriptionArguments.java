...
public @interface RoleRoleRelationConnectionSubscriptionArguments {
  ...
  RoleRoleRelationOrderBy1 orderBy() default @RoleRoleRelationOrderBy1;
  ...
  RoleRoleRelationExpression1[] exs() default {};
