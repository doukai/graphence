...
/**
 * Query Arguments for Relationship Object between 用户 and 手机号 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 用户 and 手机号 List")
public class UserPhonesRelationListQueryArguments implements MetaExpression, UserPhonesRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
