...
public @interface RoleCompositeExpression0 {
  ...
  RoleCompositeOrderBy0 orderBy() default @RoleCompositeOrderBy0;
  ...
  RoleExpression1 compositeIdType() default @RoleExpression1;
