...
public interface UserTypeListRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  PermissionTypeExpression typeListRef = null;
   ...
   */
  @Description("查询表达式组")
  Collection<UserTypeListRelationExpression> exs = null;
  ...
  default PermissionTypeExpression getTypeListRef() {
    return typeListRef;
  }

  void setTypeListRef(PermissionTypeExpression typeListRef);
  ...
  default Collection<UserTypeListRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<UserTypeListRelationExpression> exs);
}
