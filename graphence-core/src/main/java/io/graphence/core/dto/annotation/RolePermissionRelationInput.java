...
public @interface RolePermissionRelationInput {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Input")
  RolePermissionRelationInput1 input() default @RolePermissionRelationInput1;

  /**
   * Input List
   */
  @Description("Input List")
  RolePermissionRelationInput1[] list() default {};

  /**
   * Where
   */
  @Description("Where")
  RolePermissionRelationExpression1 where() default @RolePermissionRelationExpression1;
