...
@Description("用户 文件 关系 变更参数")
public class FileUserRelationMutationArguments implements MetaInput, FileUserRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("变更内容")
  private FileUserRelationInput input;
  ...
  public FileUserRelationInput getInput() {
    return this.input;
  }

  public void setInput(FileUserRelationInput input) {
    this.input = input;
  }
