...
import io.graphence.core.dto.inputObjectType.UserBooleanListRelationInput;
...
public class UserBooleanListRelation implements Meta {
  /**
   * ID
   */
  @Id
  ...
  public void setBooleanListRef(Boolean booleanListRef) {
    this.booleanListRef = booleanListRef;
  }
  ...
  public UserBooleanListRelationInput toInput() {
    UserBooleanListRelationInput input = new UserBooleanListRelationInput();
    input.setId(this.getId());
    input.setUserRef(this.getUserRef());
    if(getUser() != null) {
      input.setUser(this.getUser().toInput());
    }
    input.setBooleanListRef(this.getBooleanListRef());
