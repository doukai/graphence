...
/**
 * Query Arguments for Relationship Object between 角色 and 组 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 角色 and 组 List")
public class GroupRoleRelationListQueryArguments implements MetaExpression, GroupRoleRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
