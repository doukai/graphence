...
public @interface ApiKeyExpression1 {
  /**
   * ID
   */
  @Description("ID")
  ...
  ApiKeyExpression2[] exs() default {};

  /**
   * Order By
   */
  @Description("Order By")
  ApiKeyOrderBy2 orderBy() default @ApiKeyOrderBy2;

  /**
   * Group By
   */
  @Description("Group By")
  ApiKeyGroupBy2 groupBy() default @ApiKeyGroupBy2;
