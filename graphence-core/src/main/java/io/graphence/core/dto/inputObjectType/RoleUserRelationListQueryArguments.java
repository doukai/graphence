...
/**
 * Query Arguments for Relationship Object between 用户 and 角色 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 用户 and 角色 List")
public class RoleUserRelationListQueryArguments implements MetaExpression, RoleUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
