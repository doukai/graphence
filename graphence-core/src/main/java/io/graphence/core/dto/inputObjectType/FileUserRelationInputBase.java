...
public interface FileUserRelationInputBase extends MetaInput {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("所属类型")
  String __typename = "FileUserRelation";

  /**
   * 匹配条件
   */
  @Description("匹配条件")
  FileUserRelationExpression where = null;
  ...
  default FileUserRelationExpression getWhere() {
    return where;
  }

  void setWhere(FileUserRelationExpression where);
}
