...
public @interface GroupRoleRelationConnectionSubscriptionArguments {
  /**
   * ID
   */
  @Description("ID")
  ...
  GroupRoleRelationOrderBy orderBy() default @GroupRoleRelationOrderBy;

  /**
   * Order By
   */
  @Description("Order By")
  GroupRoleRelationGroupBy groupBy() default @GroupRoleRelationGroupBy;
  ...
  GroupRoleRelationExpression[] exs() default {};
