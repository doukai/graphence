...
public interface RoleUserRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  Collection<RoleUserRelationExpression> exs = null;
  ...
  default Collection<RoleUserRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<RoleUserRelationExpression> exs);
}
