...
/**
 * Subscription Arguments for Relationship Object between 用户 and 角色 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Subscription Arguments for Relationship Object between 用户 and 角色 List")
public class RoleUserRelationConnectionSubscriptionArguments implements MetaExpression, RoleUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Order By")
  private RoleUserRelationGroupBy groupBy;
  ...
  public RoleUserRelationGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(RoleUserRelationGroupBy groupBy) {
  ...
  public void setExs(Collection<RoleUserRelationExpression> exs) {
    this.exs = (Collection<RoleUserRelationExpression>)exs;
  }
