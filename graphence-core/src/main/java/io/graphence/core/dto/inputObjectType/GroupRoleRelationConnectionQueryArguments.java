...
/**
 * Query Arguments for Relationship Object between 角色 and 组 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 角色 and 组 Connection")
public class GroupRoleRelationConnectionQueryArguments implements MetaExpression, GroupRoleRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
