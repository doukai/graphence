...
/**
 * Query Arguments for 组 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for 组 Connection")
public class GroupConnectionQueryArguments implements TreeStructExpression, NamedStructExpression, MetaExpression, GroupExpressionBase {
  /**
   * ID
   */
  @Description("ID")
