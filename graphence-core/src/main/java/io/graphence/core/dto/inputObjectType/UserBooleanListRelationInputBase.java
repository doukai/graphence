...
public interface UserBooleanListRelationInputBase extends MetaInput {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("所属类型")
  String __typename = "UserBooleanListRelation";

  /**
   * 匹配条件
   */
  @Description("匹配条件")
  UserBooleanListRelationExpression where = null;
  ...
  default Boolean getBooleanListRef() {
    return booleanListRef;
  }

  void setBooleanListRef(Boolean booleanListRef);
  ...
  default UserBooleanListRelationExpression getWhere() {
    return where;
  }

  void setWhere(UserBooleanListRelationExpression where);
}
