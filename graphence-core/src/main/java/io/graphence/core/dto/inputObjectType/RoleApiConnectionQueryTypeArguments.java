...
@Ignore
public class RoleApiConnectionQueryTypeArguments {
  ...
  private RoleApiOrderBy orderBy;
  ...
  public RoleApiOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(RoleApiOrderBy orderBy) {
