...
public class UserTypeListRelationListMutationArguments implements MetaInput, UserTypeListRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("变更内容列表")
  private Collection<UserTypeListRelationInput> list;
  ...
  public Collection<UserTypeListRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<UserTypeListRelationInput> list) {
    this.list = list;
  }
