...
public @interface GroupRoleRelationExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  GroupRoleRelationExpression1[] exs() default {};

  /**
   * Order By
   */
  @Description("Order By")
  GroupRoleRelationOrderBy1 orderBy() default @GroupRoleRelationOrderBy1;

  /**
   * Group By
   */
  @Description("Group By")
  GroupRoleRelationGroupBy1 groupBy() default @GroupRoleRelationGroupBy1;
