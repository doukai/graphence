...
@Ignore
public class FilterConnectionQueryTypeArguments {
  ...
  public FilterOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(FilterOrderBy orderBy) {
