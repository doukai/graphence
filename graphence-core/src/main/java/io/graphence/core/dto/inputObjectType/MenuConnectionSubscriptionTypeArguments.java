...
@Ignore
public class MenuConnectionSubscriptionTypeArguments implements MetaExpression {
  ...
  public MenuOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(MenuOrderBy orderBy) {
