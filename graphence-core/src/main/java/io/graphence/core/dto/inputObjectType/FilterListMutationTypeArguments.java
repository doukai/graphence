...
@Ignore
public class FilterListMutationTypeArguments {
  private String id;
  ...
  private Collection<FilterInput> list;
  ...
  public Collection<FilterInput> getList() {
    return this.list;
  }

  public void setList(Collection<FilterInput> list) {
    this.list = list;
  }

  public FilterExpression getWhere() {
    return this.where;
  }

  public void setWhere(FilterExpression where) {
    this.where = where;
  }
}
