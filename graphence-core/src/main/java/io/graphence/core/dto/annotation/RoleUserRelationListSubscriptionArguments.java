...
public @interface RoleUserRelationListSubscriptionArguments {
  ...
  RoleUserRelationOrderBy orderBy() default @RoleUserRelationOrderBy;

  /**
   * Group By
   */
  @Description("Group By")
  RoleUserRelationGroupBy groupBy() default @RoleUserRelationGroupBy;
  ...
  RoleUserRelationExpression[] exs() default {};
