...
/**
 * Subscription Arguments for Relationship Object between 用户 and 手机号 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Subscription Arguments for Relationship Object between 用户 and 手机号 List")
public class UserPhonesRelationConnectionSubscriptionArguments implements MetaExpression, UserPhonesRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Order By")
  private UserPhonesRelationGroupBy groupBy;
  ...
  public UserPhonesRelationGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(UserPhonesRelationGroupBy groupBy) {
