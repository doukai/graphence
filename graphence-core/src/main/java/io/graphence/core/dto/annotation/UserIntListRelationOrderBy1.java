...
public @interface UserIntListRelationOrderBy1 {
  /**
   * ID
   */
  @Description("ID")
  ...
  Sort intListRef() default Sort.ASC;
  ...
  Sort intListRefCount() default Sort.ASC;

  /**
   * intList 引用 合计
   */
  @Description("intList 引用 合计")
  Sort intListRefSum() default Sort.ASC;

  /**
   * intList 引用 平均值
   */
  @Description("intList 引用 平均值")
  Sort intListRefAvg() default Sort.ASC;

  /**
   * intList 引用 最大值
   */
  @Description("intList 引用 最大值")
  Sort intListRefMax() default Sort.ASC;

  /**
   * intList 引用 最小值
   */
  @Description("intList 引用 最小值")
  Sort intListRefMin() default Sort.ASC;
  ...
  String $intListRefCount() default "";

  String $intListRefSum() default "";

  String $intListRefAvg() default "";

  String $intListRefMax() default "";

  String $intListRefMin() default "";
}
