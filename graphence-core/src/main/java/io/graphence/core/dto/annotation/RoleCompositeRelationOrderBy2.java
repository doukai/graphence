...
/**
 * Order Input for Relationship Object between 角色 and 角色
 */
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Documented
@Retention(RetentionPolicy.SOURCE)
@Target(ElementType.METHOD)
@Description("Order Input for Relationship Object between 角色 and 角色")
public @interface RoleCompositeRelationOrderBy2 {
  /**
   * ID
   */
  @Description("ID")
  ...
  /**
   * Count of Relationship Object between 角色 and 角色
   */
  @Description("Count of Relationship Object between 角色 and 角色")
