...
public @interface GroupRoleRelationInput1 {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Input")
  GroupRoleRelationInput2 input() default @GroupRoleRelationInput2;

  /**
   * Input List
   */
  @Description("Input List")
  GroupRoleRelationInput2[] list() default {};

  /**
   * Where
   */
  @Description("Where")
  GroupRoleRelationExpression2 where() default @GroupRoleRelationExpression2;
