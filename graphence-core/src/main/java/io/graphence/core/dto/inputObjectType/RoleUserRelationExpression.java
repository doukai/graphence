...
/**
 * Query Expression Input for Relationship Object between 用户 and 角色
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Expression Input for Relationship Object between 用户 and 角色")
public class RoleUserRelationExpression implements MetaExpression {
  ...
  public Collection<RoleUserRelationExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<RoleUserRelationExpression> exs) {
    this.exs = exs;
  }
