...
/**
 * Query Expression Input for Relationship Object between 角色 and 角色
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Expression Input for Relationship Object between 角色 and 角色")
public class RoleCompositeRelationExpression implements MetaExpression {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("角色 Reference")
  private StringExpression compositeRef;

  /**
   * 角色
   */
  @Description("角色")
  private RoleExpression composite;
  ...
  private Collection<RoleCompositeRelationExpression> exs;

  /**
   * Order By
   */
  @Description("Order By")
  private RoleCompositeRelationOrderBy orderBy;

  /**
   * Group By
   */
  @Description("Group By")
  private RoleCompositeRelationGroupBy groupBy;
  ...
  public StringExpression getCompositeRef() {
    return this.compositeRef;
  }

  public void setCompositeRef(StringExpression compositeRef) {
    this.compositeRef = compositeRef;
  }

  public RoleExpression getComposite() {
    return this.composite;
  }

  public void setComposite(RoleExpression composite) {
  ...
  public Collection<RoleCompositeRelationExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<RoleCompositeRelationExpression> exs) {
    this.exs = exs;
  }
  ...
  public void setOrderBy(RoleCompositeRelationOrderBy orderBy) {
    this.orderBy = orderBy;
  }

  public RoleCompositeRelationGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(RoleCompositeRelationGroupBy groupBy) {
