...
/**
 * Query Arguments for Relationship Object between 角色 and 权限
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 角色 and 权限")
public class RolePermissionRelationQueryArguments implements MetaExpression, RolePermissionRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
