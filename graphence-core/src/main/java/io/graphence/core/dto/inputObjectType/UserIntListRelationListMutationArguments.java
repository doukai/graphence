...
@Description("用户 intList 关系列表 变更参数 ")
public class UserIntListRelationListMutationArguments implements MetaInput, UserIntListRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("变更内容列表")
  private Collection<UserIntListRelationInput> list;
  ...
  public Collection<UserIntListRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<UserIntListRelationInput> list) {
    this.list = list;
  }
