...
/**
 * Mutation Arguments for Relationship Object between 用户 and 组
 */
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Documented
@Retention(RetentionPolicy.SOURCE)
@Target(ElementType.METHOD)
@Description("Mutation Arguments for Relationship Object between 用户 and 组")
public @interface GroupUserRelationMutationArguments {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Input")
  GroupUserRelationInput input() default @GroupUserRelationInput;
