...
/**
 * Subscription Arguments for Relationship Object between 角色 and 权限
 */
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Documented
@Retention(RetentionPolicy.SOURCE)
@Target(ElementType.METHOD)
@Description("Subscription Arguments for Relationship Object between 角色 and 权限")
public @interface RolePermissionRelationSubscriptionArguments {
  /**
   * ID
   */
  @Description("ID")
