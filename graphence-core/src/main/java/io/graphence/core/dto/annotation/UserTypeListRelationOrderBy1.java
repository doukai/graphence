...
public @interface UserTypeListRelationOrderBy1 {
  /**
   * ID
   */
  @Description("ID")
  ...
  Sort typeListRef() default Sort.ASC;
  ...
  Sort typeListRefCount() default Sort.ASC;

  /**
   * typeList 引用 最大值
   */
  @Description("typeList 引用 最大值")
  Sort typeListRefMax() default Sort.ASC;

  /**
   * typeList 引用 最小值
   */
  @Description("typeList 引用 最小值")
  Sort typeListRefMin() default Sort.ASC;
  ...
  String $typeListRefCount() default "";

  String $typeListRefMax() default "";

  String $typeListRefMin() default "";
}
