...
public class RoleUserRelationOrderBy {
  ...
  private Collection<RoleUserRelationOrderBy> obs;
  ...
  public Collection<RoleUserRelationOrderBy> getObs() {
    return this.obs;
  }

  public void setObs(Collection<RoleUserRelationOrderBy> obs) {
    this.obs = obs;
  }
}
