...
@Description("用户 文件 关系列表 变更参数 ")
public class FileUserRelationListMutationArguments implements MetaInput, FileUserRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("变更内容列表")
  private Collection<FileUserRelationInput> list;
  ...
  public Collection<FileUserRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<FileUserRelationInput> list) {
    this.list = list;
  }
  ...
  public void setWhere(FileUserRelationExpression where) {
    this.where = (FileUserRelationExpression)where;
  }
}
