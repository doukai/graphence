...
@Description("用户 intList 关系 变更内容")
public interface UserIntListRelationInputBase extends MetaInput {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("所属类型")
  String __typename = "UserIntListRelation";

  /**
   * 匹配条件
   */
  @Description("匹配条件")
  UserIntListRelationExpression where = null;
  ...
  default Integer getIntListRef() {
    return intListRef;
  }

  void setIntListRef(Integer intListRef);
  ...
  default UserIntListRelationExpression getWhere() {
    return where;
  }

  void setWhere(UserIntListRelationExpression where);
}
