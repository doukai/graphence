...
public interface FileUserRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("查询表达式组")
  Collection<FileUserRelationExpression> exs = null;
  ...
  default StringExpression getFileRef() {
    return fileRef;
  }

  void setFileRef(StringExpression fileRef);
  ...
  default Collection<FileUserRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<FileUserRelationExpression> exs);
}
