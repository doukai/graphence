...
/**
 * Query Arguments for Relationship Object between 用户 and 组 Connection
 */
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Documented
@Retention(RetentionPolicy.SOURCE)
@Target(ElementType.METHOD)
@Description("Query Arguments for Relationship Object between 用户 and 组 Connection")
public @interface GroupUserRelationConnectionQueryArguments {
  /**
   * ID
   */
  @Description("ID")
  ...
  GroupUserRelationGroupBy groupBy() default @GroupUserRelationGroupBy;
