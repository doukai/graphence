...
public interface RoleCompositeRelationExpressionBase extends MetaExpression {
   ...
   */
  @Description("角色 Reference")
  StringExpression compositeRef = null;

  /**
   * 角色
   */
  @Description("角色")
  RoleExpression composite = null;
  ...
  Collection<RoleCompositeRelationExpression> exs = null;
  ...
  default StringExpression getCompositeRef() {
    return compositeRef;
  }

  void setCompositeRef(StringExpression compositeRef);

  default RoleExpression getComposite() {
    return composite;
  }

  void setComposite(RoleExpression composite);
  ...
  default Collection<RoleCompositeRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<RoleCompositeRelationExpression> exs);
}
