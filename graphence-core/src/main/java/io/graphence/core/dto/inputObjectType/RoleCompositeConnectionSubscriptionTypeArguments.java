...
@Ignore
public class RoleCompositeConnectionSubscriptionTypeArguments implements MetaExpression {
  ...
  private RoleCompositeOrderBy orderBy;
  ...
  public RoleCompositeOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(RoleCompositeOrderBy orderBy) {
