...
/**
 * Query Arguments for Relationship Object between 角色 and 角色 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 角色 and 角色 List")
public class RoleCompositeRelationListQueryArguments implements MetaExpression, RoleCompositeRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
  ...
  public void setCompositeRef(StringExpression compositeRef) {
    this.compositeRef = (StringExpression)compositeRef;
  }
  ...
  public void setComposite(RoleExpression composite) {
    this.composite = (RoleExpression)composite;
  }
