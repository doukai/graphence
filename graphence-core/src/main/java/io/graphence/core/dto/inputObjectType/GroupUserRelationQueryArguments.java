...
/**
 * Query Arguments for Relationship Object between 用户 and 组
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 用户 and 组")
public class GroupUserRelationQueryArguments implements MetaExpression, GroupUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
