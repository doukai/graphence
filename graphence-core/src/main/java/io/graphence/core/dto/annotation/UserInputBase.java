...
public @interface UserInputBase {
  ...
  UserBooleanListRelationInput1[] userBooleanListRelation() default {};

  /**
   * 用户 intList 关系
   */
  @Description("用户 intList 关系")
  UserIntListRelationInput1[] userIntListRelation() default {};

  /**
   * 用户 typeList 关系
   */
  @Description("用户 typeList 关系")
  UserTypeListRelationInput1[] userTypeListRelation() default {};
