...
public interface UserIntListRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("查询表达式组")
  Collection<UserIntListRelationExpression> exs = null;
  ...
  default IntExpression getIntListRef() {
    return intListRef;
  }

  void setIntListRef(IntExpression intListRef);
  ...
  default Collection<UserIntListRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<UserIntListRelationExpression> exs);
}
