...
/**
 * Query Arguments for Relationship Object between 用户 and 角色
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 用户 and 角色")
public class RoleUserRelationQueryArguments implements MetaExpression, RoleUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
