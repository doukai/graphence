...
public @interface GroupUserRelationExpression1 {
  /**
   * ID
   */
  @Description("ID")
  ...
  GroupUserRelationExpression2[] exs() default {};

  /**
   * Order By
   */
  @Description("Order By")
  GroupUserRelationOrderBy2 orderBy() default @GroupUserRelationOrderBy2;

  /**
   * Group By
   */
  @Description("Group By")
  GroupUserRelationGroupBy2 groupBy() default @GroupUserRelationGroupBy2;
