...
public class UserTypeListRelationMutationArguments implements MetaInput, UserTypeListRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("变更内容")
  private UserTypeListRelationInput input;
  ...
  public UserTypeListRelationInput getInput() {
    return this.input;
  }

  public void setInput(UserTypeListRelationInput input) {
    this.input = input;
  }
