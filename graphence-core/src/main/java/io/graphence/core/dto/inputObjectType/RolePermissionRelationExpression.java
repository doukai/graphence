...
public class RolePermissionRelationExpression implements MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  public Collection<RolePermissionRelationExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<RolePermissionRelationExpression> exs) {
    this.exs = exs;
  }
