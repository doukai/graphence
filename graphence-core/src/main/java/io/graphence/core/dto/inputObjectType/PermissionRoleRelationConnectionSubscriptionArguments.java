...
public class PermissionRoleRelationConnectionSubscriptionArguments implements MetaExpression, PermissionRoleRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
  ...
  public void setOrderBy(PermissionRoleRelationOrderBy orderBy) {
