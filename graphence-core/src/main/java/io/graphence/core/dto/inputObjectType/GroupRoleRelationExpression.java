...
public class GroupRoleRelationExpression implements MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  public Collection<GroupRoleRelationExpression> __dslJson_exs() {
    return this.exs;
  }
  ...
  public void __dslJson_exs(Collection<GroupRoleRelationExpression> exs) {
    this.exs = exs;
  }
