...
public interface PermissionRoleRelationInputBase extends MetaInput {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("所属类型")
  String __typename = "PermissionRoleRelation";

  /**
   * 匹配条件
   */
  @Description("匹配条件")
  PermissionRoleRelationExpression where = null;
  ...
  default PermissionRoleRelationExpression getWhere() {
    return where;
  }

  void setWhere(PermissionRoleRelationExpression where);
}
