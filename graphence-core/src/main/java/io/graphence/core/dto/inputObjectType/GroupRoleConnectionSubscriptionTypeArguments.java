...
@Ignore
public class GroupRoleConnectionSubscriptionTypeArguments implements MetaExpression {
  ...
  private GroupRoleOrderBy orderBy;
  ...
  private Collection<GroupRoleExpression> exs;
  ...
  public GroupRoleOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(GroupRoleOrderBy orderBy) {
  ...
  public Collection<GroupRoleExpression> getExs() {
    return this.exs;
  }

  public void setExs(Collection<GroupRoleExpression> exs) {
    this.exs = exs;
  }
