...
public @interface UserPhonesRelationInput1 {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Input")
  UserPhonesRelationInput2 input() default @UserPhonesRelationInput2;

  /**
   * Input List
   */
  @Description("Input List")
  UserPhonesRelationInput2[] list() default {};

  /**
   * Where
   */
  @Description("Where")
  UserPhonesRelationExpression2 where() default @UserPhonesRelationExpression2;
