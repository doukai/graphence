...
public @interface ApiKeyExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  ApiKeyExpression1[] exs() default {};

  /**
   * Order By
   */
  @Description("Order By")
  ApiKeyOrderBy1 orderBy() default @ApiKeyOrderBy1;

  /**
   * Group By
   */
  @Description("Group By")
  ApiKeyGroupBy1 groupBy() default @ApiKeyGroupBy1;
