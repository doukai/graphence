...
@Ignore
public class RoleCompositeListMutationTypeArguments implements MetaInput {
  private String id;
  ...
  private Collection<RoleCompositeInput> list;
  ...
  public Collection<RoleCompositeInput> getList() {
    return this.list;
  }

  public void setList(Collection<RoleCompositeInput> list) {
    this.list = list;
  }
