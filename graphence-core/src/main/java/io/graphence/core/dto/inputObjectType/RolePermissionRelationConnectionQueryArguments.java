...
/**
 * Query Arguments for Relationship Object between 角色 and 权限 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder")
@Description("Query Arguments for Relationship Object between 角色 and 权限 Connection")
public class RolePermissionRelationConnectionQueryArguments implements MetaExpression, RolePermissionRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
  ...
  private RolePermissionRelationOrderBy orderBy;

  /**
   * Group By
   */
  @Description("Group By")
  private RolePermissionRelationGroupBy groupBy;
  ...
  private Collection<RolePermissionRelationExpression> exs;
  ...
  public void setOrderBy(RolePermissionRelationOrderBy orderBy) {
    this.orderBy = orderBy;
  }

  public RolePermissionRelationGroupBy getGroupBy() {
    return this.groupBy;
  }

  public void setGroupBy(RolePermissionRelationGroupBy groupBy) {
