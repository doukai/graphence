...
public class PermissionBuilder {
    ...
    @Inject
    public PermissionBuilder(DocumentManager documentManager, MutationHandler mutationHandler, SecurityConfig securityConfig) {
        this.documentManager = documentManager;
        this.mutationHandler = mutationHandler;
        this.securityConfig = securityConfig;
    }

    public Mono<Void> buildPermission(@Observes @Initialized(ApplicationScoped.class) @Priority(PermissionBuilder.PERMISSION_BUILD_SCOPE_EVENT_PRIORITY) Object event) {
