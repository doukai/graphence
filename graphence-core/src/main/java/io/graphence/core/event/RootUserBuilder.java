...
public class RootUserBuilder {
  ...
  public static final int ROOT_USER_BUILD_SCOPE_EVENT_PRIORITY =
      DOCUMENT_INITIALIZED_SCOPE_EVENT_PRIORITY + 110;
  ...
  public Mono<Void> buildRootUser(
      @Observes
          ...
          @Priority(RootUserBuilder.ROOT_USER_BUILD_SCOPE_EVENT_PRIORITY)
          Object event) {
    ...
    return userRepository
        .getUserIdByLogin(securityConfig.getRootUser())
        .map(
            user -> {
